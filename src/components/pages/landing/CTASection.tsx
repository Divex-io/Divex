...
export default function CTASection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-1/2 right-20 w-12 h-12 bg-white/10 rounded-full"
        animate={{
          scale: [1, 1.2, 1],
          rotate: [0, 180, 360],
        }}
        ...
        >
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                <motion.div
                  className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4 backdrop-blur-sm"
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-semibold transition-all duration-300 backdrop-blur-sm"
              >
                {t("scheduleDemo")}
              </Button>
            </motion.div>
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className="text-blue-100">{t("trustedDescription")}</p>
            </div>
          ...
          >
            <div className="flex flex-wrap justify-center items-center gap-6 text-blue-100 text-lg">
